...
Revision ID: 89f1a9165e4f
Revises: 
Create Date: 2026-05-17 15:57:24.697869
...
def upgrade() -> None:
    ...
    sa.Column('promo_type', sa.Enum('free_item', 'item_discount', 'order_discount', name='promotype'), nullable=False),
